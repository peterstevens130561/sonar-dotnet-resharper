...
public class FailingIssuesListenerTest {
    ...
    File resultFile;
    FailingIssueListener failingIssuesListener;
    ...
    public void init() throws Exception {
        ...
        failingIssuesListener = new FailingIssueListener();
    ...
    private void appendLogger() {
        ...
        Logger log = loggerContext.getLogger(FailingIssueListener.class);
